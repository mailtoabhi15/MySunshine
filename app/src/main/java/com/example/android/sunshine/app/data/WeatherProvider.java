...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        sURIMatcher.addURI(autority,WeatherContract.PATH_WEATHER,WEATHER );
        sURIMatcher.addURI(autority,WeatherContract.PATH_WEATHER + "/*",WEATHER_WITH_LOCATION );
        // /location/*/date#
        sURIMatcher.addURI(autority,WeatherContract.PATH_WEATHER + "/*/#" ,WEATHER_WITH_LOCATION_AND_DATE );

        sURIMatcher.addURI(autority,WeatherContract.PATH_LOCATION,LOCATION );
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        //Dixit-Imp:this makes delete all rows return the no. of rows deleted
        if (selection == null)
            selection = "1";
        ...
        //Dixit-imp:coz a null deletes all rows
        if(rowsDeleted!=0)
            getContext().getContentResolver().notifyChange(uri,null);
