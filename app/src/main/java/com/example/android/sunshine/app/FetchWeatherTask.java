...
//                mContext.getString(R.string.pref_temp_units_metrics));
//
//        if (unitType.equals(mContext.getString(R.string.pref_temp_units_imperial))) {
//            high = (high * 1.8) + 32;
//            low = (low * 1.8) + 32;
//        } else if (!unitType.equals(mContext.getString(R.string.pref_temp_units_metrics))) {
...
//            return resultStrs;
    ...
    protected Void doInBackground(String... params) {
        ...
        //Dixit-imp: These two need to be declared outside the try/catch
